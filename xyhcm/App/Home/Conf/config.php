...
$config_base = array(
	...
	'URL_MODEL'         => get_cfg_value('HOME_URL_MODEL'),
	'URL_PATHINFO_DEPR' => get_cfg_value('HOME_URL_PATHINFO_DEPR'),

	//路由
	'URL_ROUTER_ON'     => get_cfg_value('HOME_URL_ROUTER_ON'),
	'URL_ROUTE_RULES'   => get_cfg_value('HOME_URL_ROUTE_RULES'),

	//开启静态缓存
	'HTML_CACHE_ON'     => get_cfg_value('HOME_HTML_CACHE_ON'),
