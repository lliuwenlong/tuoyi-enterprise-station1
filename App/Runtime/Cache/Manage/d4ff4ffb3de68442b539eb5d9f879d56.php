...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/cms222/xyhai.php?s=/Link';
	    var APP	 = '/cms222/xyhai.php?s=';
	    var SELF='/cms222/xyhai.php?s=/Link/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加链接</button>
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php if($v['is_check']): ?>内页<?php else: ?>首页<?php endif; ?></td>
