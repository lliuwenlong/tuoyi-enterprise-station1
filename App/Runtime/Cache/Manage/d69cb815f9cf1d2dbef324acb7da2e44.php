...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/xyhai.php?s=';
	    var SELF='/xyhai.php?s=/Category/edit/id/1';
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('edit');?>">
					...
					<div class="tab-content" style="margin-top:20px;">
						<div role="tabpanel" class="tab-pane active" id="home">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select name="model_id" class="form-control">
										<?php if(is_array($mlist)): foreach($mlist as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($data['model_id'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
									</select>									
								</div>
							</div>							
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="name" id="inputName" value="<?php echo ($data["name"]); ?>" class="form-control" placeholder="栏目名称" />									
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									    <input type="text" class="form-control" name="cat_pic" id="cat_pic" value="<?php echo ($data["cat_pic"]); ?>" placeholder="栏目图片地址" />	
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="style" id="inputStyle" value="<?php echo ($data["style"]); ?>" class="form-control" placeholder="css样式" />								
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<label class="radio-inline">
									 	<input type="radio" name="status" value="4" <?php if($data['status'] == 4): ?>checked="checked"<?php endif; ?> />禁止访问		
									 </label>		
								</div>
							</div>
						...
						<div role="tabpanel" class="tab-pane" id="profile">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="seo_title" id="inputSeotitle" value="<?php echo ($data["seo_title"]); ?>" class="form-control" placeholder="Seo标题" />
								</div>
							</div>
							<div class="form-group">
									...
									<table class="table table-hover xyh-table-bordered-out-small">
										<thead>
										  ...
										  <?php if(is_array($roleList)): foreach($roleList as $key=>$v): ?><tr>
										    ...
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="index,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'index',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="add,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'add',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="edit,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'edit',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="del,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'del',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="move,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'move',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="trach,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'trach',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="restore,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'restore',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
										    <td align="center"><input type="checkbox" name="acc_role_id[]" value="clear,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'],'clear',$v['id']) == 1): ?>checked="checked"<?php endif; ?> /></td>
									...
									<table class="table table-hover xyh-table-bordered-out-small">
									  ...
									  <tbody>
										  <?php if(is_array($groupList)): foreach($groupList as $key=>$v): ?><tr>
										    ...
										    <td align="center"><input type="checkbox" name="acc_group_id[]" value="visit,<?php echo ($v["id"]); ?>" <?php if(check_category_access($data['id'], 'visit', $v['id'], 0) == 1): ?>checked="checked"<?php endif; ?> /></td>
										  </tr><?php endforeach; endif; ?>
									  </tbody>
									</table>								
								</div>
					...
					<div class="row">
						<div class="col-sm-offset-2 col-sm-9">
							...
							<input type="hidden" name="old_model_id" value="<?php echo ($data["model_id"]); ?>"/>
							<div class="btn-group">
